...
console.log('Unclosed braces (last 10):', braceStack.slice(-10));
console.log('Unclosed parens (last 10):', parenStack.slice(-10));
console.log('Unclosed brackets (last 10):', bracketStack.slice(-10));
